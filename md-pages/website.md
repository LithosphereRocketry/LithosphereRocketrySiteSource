...
Something I didn't realize until fairly late into the process was that generated
...
it was getting late in the day and I just wanted to get stuff up and running.

The solution I ended up with is a fairly hacky Python script that takes in an
...
not sure whether it's worth fixing at this moment.

In the process of doing this, I realized that it would probably be nice to have
...
until no new substitutions remain.
